  ...
  ITG3205: {
    ...
    initialize: {
      value: function(board, opts) {
        ...
        var gyroOffX = opts.gyroOffX || 120;
        var gyroOffY = opts.gyroOffY || 20;
        var gyroOffZ = opts.gyroOffZ || 93;
        ...
        io.i2cRead(address, this.REGISTER.READ, READLENGTH, function(data) {
          ...
          var rawTemp =  int16(data[0], data[1]);
          var actualTemp = 35+ (rawTemp + 13200) / 280;

          computed.temperature = actualTemp;

          computed.gyro = {
            x: int16(data[2], data[3]) + gyroOffX,
            y: int16(data[4], data[5]) + gyroOffY,
            z: int16(data[6], data[17]) + gyroOffZ
          };
    ...
    identifier: {
      value: function(opts) {
        var address = opts.address || Drivers.ITG3205.ADDRESSES.value[0];
        return "itg-3205-" + address;
      }
    }
  },
  BNO055: {
...
var Controllers = {
  ITG3205: {
    initialize: {
      value: function(opts) {
        Components.call(this, "ITG3205", opts);
      }
    },
    components: {
      value: [GYRO, THERMOMETER]
    }
  },
